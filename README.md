...
## 一、前端工程师解析
###### 前端工程师定义
* 前端工程师是一个近几年才兴起的职位，是互联网发展到一定阶段的产物。
...
* 我个人曾经在大学的时候学习过网页制作，接触过CSS和HTML，也应用过JS，现在也有兴趣学习这方面的知识。如果在学习过程中发现自己很感兴趣，也比较适合或者能够胜任相关工作的话，我就开始向职业方向靠拢。
###### 职责
* 项目前期：分析-评估-规范-选型-培训
